...
This returns a data-frame with columns (correlation coefs, if present in the
coxpresdb archive, are disregarded since they aren't present consistently)
(`source_id,   target_id,   mutual_rank`)
